...
void Draw_Cartman_Fly()
{
...

    {
        ...
        Draw_Cartman    (ix - (int)(0.5 * t), t,   0.003 * t, 0.003 * t, MY_LIGHT_RED, MY_FACE, TX_YELLOW,      0, 0, 0, 0, 0, 0, 0, 0, 1);
...
void Draw_Greeting()
{
...

   {
        ...
        Draw_Cartman    (150, 450, 1, 1, MY_LIGHT_RED, MY_FACE, TX_YELLOW,      0, (t / 10) % 2,  0,            0,            0,            1,            (t / 25) % 2, 0, 0);
...
void Draw_Hat(int x, int y, float sizeX, float sizeY,int Jump, COLORREF Hat_Color, COLORREF Pompon_Color, int is_Cartman)
{
     ...
     txPie	        (x - 45 * sizeX - 10 * sizeX * is_Cartman,  y - 50 * sizeY + Jump,
                     ...
                     x + 45 * sizeX + 10 * sizeX * is_Cartman,  y + Jump,              0, 180);
